...
set_clock_groups -asynchronous -group [get_clocks {flash_clk}] -group [get_clocks {m0s[3]}] -group [get_clocks {ds_clk}] -group [get_clocks {ds2_clk}] -group [get_clocks {mspi_clk}]  -group [get_clocks {clk32}]
