...
//Created Time: 2024-11-25 08:30:16
...
set_clock_groups -asynchronous -group [get_clocks {flash_clk}] -group [get_clocks {ds_clk}] -group [get_clocks {ds2_clk}]  -group [get_clocks {m0sclk}] -group [get_clocks {mspi_clk}] -group [get_clocks {clk_audio}] -group [get_clocks {clk32}] -group [get_clocks {clk_pixel_x5}]
